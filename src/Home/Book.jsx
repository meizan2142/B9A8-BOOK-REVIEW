            ...
            <div>
                <div className="card bg-base-100 shadow-2xl">
                    <figure className="px-10 pt-10">
                        <img src="https://i.ibb.co/B66s3VK/pngwing-com-1.png" alt="Shoes" className="rounded-xl w-52 lg:w-[280px] lg:h-[250px] bg-[#1313130d] shadow-xl" />
                    </figure>
                    <div className="card-body">
                        ...
                        <div className="mt-4 space-y-4">
                            <h1 className="text-2xl font-bold">The Catcher in the Rye</h1>
                            <p className="#131313cc text-base font-medium">By : Awlad Hossain</p>
                        </div>
